...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        expense = (Expense) i.getSerializableExtra("expense");

        mVisible = true;
        //mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = findViewById(R.id.fullScreenPicture);
        ...
        picture = (ImageView) findViewById(R.id.fullScreenPicture);
    ...
    private void setPic() {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(expense.getPhotoPath(), bmOptions);
